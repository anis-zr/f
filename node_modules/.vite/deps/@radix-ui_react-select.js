...
import {
  ...
  size,
  useFloating
} from "./chunk-2HMXRP5M.js";
import {
  Combination_default,
  hideOthers
} from "./chunk-FSIBPT4A.js";
import {
  require_jsx_runtime
} from "./chunk-SFYLIIXY.js";
import {
  require_react_dom
} from "./chunk-X4ABJF3L.js";
import {
  require_react
} from "./chunk-5KBRTDZH.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
  __toESM
} from "./chunk-E6MBODIG.js";
...
function useComposedRefs3(...refs) {
  return React21.useCallback(composeRefs4(...refs), refs);
}
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React24.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime15.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React24.isValidElement(newElement) ? React24.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React24.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var useLayoutEffect23 = (globalThis == null ? void 0 : globalThis.document) ? React28.useLayoutEffect : () => {
};

// node_modules/@radix-ui/react-use-size/dist/index.mjs
function useSize(element) {
  const [size2, setSize] = React29.useState(void 0);
  useLayoutEffect23(() => {
    if (element) {
...
var PopperAnchor = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime17.jsx)(Primitive3.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var PopperContent = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React30.useState(null);
...
var Portal = React31.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime18.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var useReactEffectEvent = React33[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect = React33[" useInsertionEffect ".trim().toString()];

// node_modules/@radix-ui/react-select/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect = React34[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
function useControllableState({
  ...
  if (true) {
    const isControlledRef = React34.useRef(prop !== void 0);
    React34.useEffect(() => {
...
function useUncontrolledState({
  ...
  const [value, setValue] = React34.useState(defaultProp);
  const prevValueRef = React34.useRef(value);
  const onChangeRef = React34.useRef(onChange);
  useInsertionEffect(() => {
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React37.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React37.Children.count(newElement) > 1)
            return React37.Children.only(null);
          return React37.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime19.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React37.isValidElement(newElement) ? React37.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime22.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime22.jsxs)(
    SelectProvider,
    {
      ...
      disabled,
      children: [
        (0, import_jsx_runtime22.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime22.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM6.createPortal(
        (0, import_jsx_runtime22.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime22.jsx)(Collection.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime22.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
...
var SelectContentImpl = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst2 = React40.useCallback(
      (candidates) => {
    ...
    return (0, import_jsx_runtime22.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime22.jsx)(Combination_default, { as: Slot6, allowPinchZoom: true, children: (0, import_jsx_runtime22.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, { children: [
      ...
      (0, import_jsx_runtime22.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime22.jsx)(
        Primitive.div,
        {
...
var SelectItem = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textValue, setTextValue] = React40.useState(textValueProp ?? "");
...
var SelectArrow = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime22.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
